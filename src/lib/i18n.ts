...
export const UI = {
  ...
  // GAS therapy goals (Zielerreichungsskala nach Kiresuk & Sherman).
  goalsTitle: L("Therapieziele (GAS)", "Objectifs thérapeutiques (GAS)", "Therapy goals (GAS)"),
  goalsViewTitle: L("Therapieziele — Zielerreichungsskala (GAS)", "Objectifs thérapeutiques — échelle d'atteinte des objectifs (GAS)", "Therapy goals — Goal Attainment Scaling (GAS)"),
  goalsMethodNote: L(
    "Goal Attainment Scaling nach Kiresuk & Sherman: 0 = Ausgangslage, +1 bis +3 = erwünschte Veränderung, −1 = Verschlechterung.",
    "Goal Attainment Scaling selon Kiresuk & Sherman : 0 = situation initiale, +1 à +3 = changement souhaité, −1 = détérioration.",
    "Goal Attainment Scaling after Kiresuk & Sherman: 0 = baseline, +1 to +3 = desired change, −1 = deterioration."),
  openGoalsView: L("Therapieziele öffnen", "Ouvrir les objectifs", "Open therapy goals"),
  goalsNone: L("Noch keine Therapieziele erfasst.", "Aucun objectif thérapeutique saisi.", "No therapy goals recorded yet."),
  goalsDefine: L("Ziele erfassen", "Saisir les objectifs", "Define goals"),
  goalChartTitle: L("Zielerreichung im Verlauf", "Atteinte des objectifs au fil du temps", "Goal attainment over time"),
  goalChartEmpty: L(
    "Noch keine Bewertungen — der Verlauf erscheint nach der ersten Einschätzung.",
    "Pas encore d'évaluations — l'évolution apparaît après la première appréciation.",
    "No ratings yet — the trajectory appears after the first rating."),
  goalBaseline: L("Ausgangslage", "Situation initiale", "Baseline"),
  goalLevelBaseline: L("Ausgangslage, Ist-Zustand", "Situation initiale, état actuel", "Baseline, current state"),
  goalLevelNegative: L("Negative Veränderung", "Changement négatif", "Negative change"),
  goalLevelPositive: L("Positive, erwünschte Veränderung", "Changement positif souhaité", "Positive, desired change"),
  goalCurrent: L("Aktuell", "Actuel", "Current"),
  goalCurrentRating: L("Aktuelle Einschätzung: {level} · {date}", "Appréciation actuelle : {level} · {date}", "Current rating: {level} · {date}"),
  goalNoRatings: L("Noch keine Bewertung", "Pas encore d'évaluation", "Not yet rated"),
  goalRateTitle: L("Zielerreichung einschätzen", "Évaluer l'atteinte de l'objectif", "Rate goal attainment"),
  goalRateSave: L("Bewertung speichern", "Enregistrer l'évaluation", "Save rating"),
  goalRateDate: L("Datum", "Date", "Date"),
  goalRatingHistory: L("Bisherige Einschätzungen", "Appréciations précédentes", "Rating history"),
  goalAddTitle: L("Neues Ziel", "Nouvel objectif", "New goal"),
  goalTitleLabel: L("Ziel", "Objectif", "Goal"),
  goalTitlePlaceholder: L("Ziel: …", "Objectif : …", "Goal: …"),
  goalLevelDescPlaceholder: L("Beschreibung dieser Stufe…", "Description de ce niveau…", "Description of this level…"),
  goalSave: L("Ziel speichern", "Enregistrer l'objectif", "Save goal"),
  goalEdit: L("Bearbeiten", "Modifier", "Edit"),
  goalCancel: L("Abbrechen", "Annuler", "Cancel"),
  goalDelete: L("Löschen", "Supprimer", "Delete"),
  goalDeleteConfirm: L("Endgültig löschen", "Supprimer définitivement", "Delete permanently"),
  goalsPatientTitle: L("Ihre Therapieziele", "Vos objectifs thérapeutiques", "Your therapy goals"),
  goalsPatientHint: L(
    "Diese Ziele haben Sie gemeinsam mit Ihrer Therapeutin / Ihrem Therapeuten festgelegt.",
    "Vous avez défini ces objectifs avec votre thérapeute.",
    "You defined these goals together with your therapist."),
  ...
  icdSuppressedTag: L("In F40.01 enthalten", "Inclus dans F40.01", "Subsumed in F40.01"),
  ...
  dropoutMeta: L("Modell aus n={n} abgeschlossenen Behandlungen · Basisrate {base} % · AUC {auc} (In-Sample, optimistisch)", "Modèle basé sur n={n} traitements terminés · taux de base {base} % · AUC {auc} (in-sample, optimiste)", "Model from n={n} completed treatments · base rate {base}% · AUC {auc} (in-sample, optimistic)"),
  ...
  clinSevLabel: L("Schweregrad (Therapeut*in, 0–8)", "Sévérité (thérapeute, 0–8)", "Severity (therapist, 0–8)"),
